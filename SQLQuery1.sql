...
INSERT [dbo].[Person] ([Person_ID], [First_Name], [Last_Name], [Middle_Initial], [Address_ID], [Phone_Number]) VALUES (1, N'Mark                          ', N'Degallier                     ', N'J', NULL, NULL)
INSERT [dbo].[Person] ([Person_ID], [First_Name], [Last_Name], [Middle_Initial], [Address_ID], [Phone_Number]) VALUES (2, N'Joe                           ', N'Schmo                         ', NULL, NULL, NULL)
INSERT [dbo].[Person] ([Person_ID], [First_Name], [Last_Name], [Middle_Initial], [Address_ID], [Phone_Number]) VALUES (3, N'Sally                         ', N'Doe                           ', N'G', NULL, NULL)
INSERT [dbo].[Person] ([Person_ID], [First_Name], [Last_Name], [Middle_Initial], [Address_ID], [Phone_Number]) VALUES (4, N'George                        ', N'Castanza                      ', NULL, NULL, NULL)
INSERT [dbo].[Person] ([Person_ID], [First_Name], [Last_Name], [Middle_Initial], [Address_ID], [Phone_Number]) VALUES (5, N'Billy                         ', N'Holiday                       ', NULL, NULL, NULL)
